...
H = \sqrt {\frac{{{N_T}{N_R}}}{\rho }} \sum\limits_{l = 1}^L {{\alpha_l}{\mathbf{a}_T}({\theta_l})\mathbf{b}_R^ *({\varphi_l})}" />
...
<img src="http://latex.codecogs.com/gif.latex? \mathbf{a}_{T}(\theta_{l})=\frac{1}{\sqrt{N_{T}}}[1, e^{j2\pi d\text{sm}(\theta)/\lambda},\cdots, e^{j2\pi(N_{T}-1)d\sin(\theta_{l})/\lambda}]^{\text{T}}
" />  
and  

<img src="http://latex.codecogs.com/gif.latex? \mathbf{b}_{R}(\varphi_{l})=\frac{1}{\sqrt{N_{R}}}[1, e^{j2\pi d\sin(\varphi)/\lambda},\cdots, e^{j2\pi(N_{R}-1)d\sin(\varphi_{l})/\lambda}]^{\text{T}}
" />  
...
* Ultra-high data rates per area and ultra-mas-sive amounts of connected devices  
...
<img src="http://latex.codecogs.com/gif.latex?
\zeta (r) = \left\{ {\begin{array}{*{20}{l}}
{{\zeta _1}(r),}&{{\rm{when}}0 \le r \le {d_1}}\\
{{\zeta _2}(r),}&{{\rm{when}}{d_1} < r \le {d_2}}\\
 \vdots & \vdots \\
{{\zeta _N}(r),}&{{\rm{when}}r > {d_{N - 1}}}
\end{array}} \right.
" />  
